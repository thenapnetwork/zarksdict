...
export default () => {
    return <div className="privacy">
        <div className="header">
            ...
            <h5>修訂日期: 2022/12/04 17:03 UTC+8</h5>
        </div>
        ...
        <div className="body">
            ...
            <div>
                ...
                <p>您可以透過以下管道聯繫我們:</p>
                <ul>
                    <li>Twitter: <a href="https://twitter.com/kamiyurisaka">@kamiyurisaka</a></li>
            ...
            <div>
                <h3>資料的儲存</h3>
                <p>由於這個應用程式僅於您的瀏覽器上執行，因此無須擔心您的資料會被儲存到我們遠端的伺服器上。亦我們的應用程式是由三恣網路所代管的，我們必須遵守<a href="https://www.3zh-studio.com/service/privacy">《三恣網路隱私權政策》</a>。</p>
                <p>您的資料會在您關閉瀏覽器(或關閉這個網頁程式)時自動清除。因此無須擔心您的資料會於您不知道的時候被使用、瀏覽。</p>
            </div>
            ...
            <div>
                <h3>資料的分享</h3>
                <p>我們的應用程式是由三恣網路所代管的，我們必須遵守<a href="https://www.3zh-studio.com/service/privacy">《三恣網路隱私權政策》</a>，且該條約限制我們不能在未經授權的情況下與第三方分享您的「所有」資料，因此我們向您保證我們絕不會與第三方分享您的資料，且由於我們並不會於遠端伺服器上儲存您所使用的檔案，因此我們亦無法與第三方分享您的檔案。您可以放心使用這個網頁程式來解析您的檔案。</p>
            </div>
